...
from .encoders.encoders import DataSetEncoders, PosEncoder
from .encoders.composition import Concat2NodeEncoder
...
class ActivationType(Enum):
    ...
    def get(self):
        if self is ActivationType.RELU:
            ...
            return F.gelu
        elif self is ActivationType.LEAKY_RELU:
            return F.leaky_relu
        else:
...
def get_pool() -> Pool:
    # Devuelve una instancia de Pool con el tipo de agrupamiento necesario
    return Pool.NONE
