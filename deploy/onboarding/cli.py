"""CLI entrypoint for the onboarding pipeline.

Orchestrates Phases 1-7b per spec §7. Exit codes per §6.4.
"""
import argparse
import os
import sys
...
# Load .env from the repo root (or any ancestor) into the process env.
# Variables already set in the shell win: load_dotenv does not override.
load_dotenv(find_dotenv(usecwd=True))

from deploy.onboarding.manifest import ManifestError, load_manifest  # noqa: E402
from deploy.onboarding.secrets import write_secrets  # noqa: E402
...
from deploy.onboarding.tb import (  # noqa: E402
    ExternalError, REQUIRED_PROFILES,
    ensure_profiles, ensure_writeback_devices, ensure_gateway_device,
    tb_get_device_by_name, tb_list_profiles,
    tb_login,
)
